...
class RegistrationScreen extends StatefulWidget {
  const RegistrationScreen({Key? key, required  this.rollnumber}) : super(key: key);
              ...
              SizedBox(
                ...
                child: TextField(
                  controller: textEditingController,
                    decoration: const InputDecoration( fillColor: Colors.white, filled: true,hintText: "Enter Roll Number")
                ),
              ),
              const SizedBox(height: 10,),

      //         SizedBox(
      //  child: Text('${widget.rollnumber}',style: TextStyle(color: Colors.blue),),
      //         ),
              const SizedBox(height: 10,),
              ElevatedButton(
                  onPressed: () {
